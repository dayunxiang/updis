...
let conduits = mapUtil.getDescendantConduitsOfSubcatchment(subcatchmentFeature, cy)
console.log('conduits: ', conduits)

let outfalls = mapUtil.getDescendantOutfallsOfSubcatchment(subcatchmentFeature, cy)
